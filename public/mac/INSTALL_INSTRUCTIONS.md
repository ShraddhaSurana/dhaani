...
1. Download all three files: `Dhaani-0.1.0-arm64.dmg`, `Install_Dhaani.command`, and this `INSTALL_INSTRUCTIONS.md` file.
...
```bash
hdiutil attach Dhaani-0.1.0-arm64.dmg
cp -R /Volumes/Dhaani/Dhaani.app /Applications
xattr -dr com.apple.quarantine /Applications/Dhaani.app
open /Applications/Dhaani.app
hdiutil detach /Volumes/Dhaani
```

Need help? Contact Shraddha at shraddha.surana@gmail.com.
